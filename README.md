...
```bash
uv add "airas-eval==0.10.0"     # ライブラリ/CLI として
uvx airas-eval@0.10.0 list      # インストールせずに CLI だけ使う
```
...
git commit -am "release: v0.10.0" && git tag v0.10.0 && git push --tags
```
