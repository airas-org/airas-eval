...
```bash
uv add "airas-eval==0.7.1"     # ライブラリ/CLI として
uvx airas-eval@0.7.1 list      # インストールせずに CLI だけ使う
```
...
git commit -am "release: v0.7.1" && git tag v0.7.1 && git push --tags
```
