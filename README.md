...
```bash
uv add "airas-eval==0.5.0"     # ライブラリ/CLI として
uvx airas-eval@0.5.0 list      # インストールせずに CLI だけ使う
```
...
git commit -am "release: v0.5.0" && git tag v0.5.0 && git push --tags
```
